    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          {/* For Farmers */}
          <div>
            <h3 className="text-white font-semibold text-lg mb-4">For Farmers</h3>
            <ul className="space-y-2">
              <li>
                <Link to="/register" className="text-sm hover:text-green-500 transition-colors">
                  Become a Seller
                </Link>
              </li>
              <li>
                <Link to="/dashboard" className="text-sm hover:text-green-500 transition-colors">
                  Seller Dashboard
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/guidelines" className="text-sm hover:text-green-500 transition-colors">
                  Selling Guidelines
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li className="flex items-start space-x-2">
                ...
                <span>support@kisanbazar.com</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg className="w-5 h-5 text-green-500 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-400">
              © {currentYear} Kisan Bazar. All rights reserved.
            </p>
            <div className="flex space-x-6">
              ...
              <Link to="/refund" className="text-sm text-gray-400 hover:text-green-500 transition-colors">
                Refund Policy
              </Link>
            </div>
          </div>
